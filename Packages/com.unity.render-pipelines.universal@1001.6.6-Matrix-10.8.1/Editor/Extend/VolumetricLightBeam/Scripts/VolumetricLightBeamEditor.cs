...
namespace VLB
{
    ...
    public class VolumetricLightBeamEditor : EditorCommon
    {
        ...
        SerializedProperty blendingMode = null, shaderAccuracy = null, enableDoubleSide = null;
        ...
        SerializedProperty coneRadiusStart = null, geomMeshType = null, geomCustomSides = null, geomCustomSegments = null, geomCap = null, geomLODSettings = null;
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (FoldableHeader.Begin(this, EditorStrings.Beam.HeaderBasic))
            {
                ...
                EditorGUI.BeginChangeCheck();
                {
                    EditorGUILayout.PropertyField(enableDoubleSide);
                }
                if (EditorGUI.EndChangeCheck()) { SetBeamGeomDirty(); }
            ...
            if (geomMeshType.intValue == (int)MeshType.LOD)
            {
                EditorGUI.indentLevel++;
                EditorGUI.BeginChangeCheck();
                {
                    EditorGUILayout.PropertyField(geomLODSettings);
                }
                if (EditorGUI.EndChangeCheck()) { SetBeamGeomDirty(); }
                EditorGUI.indentLevel--;
            }
        ...
        void SetBeamGeomDirty()
        {
            foreach (var entity in m_Targets) entity._EditorSetBeamGeomDirty();
        }
