...
namespace UnityEditor
{
    public abstract class BaseShaderGUI : ShaderGUI
    {
        ...
        protected class Styles
        {
            ...
            public static readonly GUIContent emissionColor = new GUIContent("Emission Color",
                "Sets a Texture map to use for emission. You can also select a color with the color picker. Colors are multiplied over the Texture.");
            //PicoVideo;LightMode;YangFan;End
            
            //PicoVideo;LightMode;XiaoPengCheng;Begin
            public static readonly GUIContent emissionCubeMap = new GUIContent("Emission CubeMap",
                "Sets a Texture CubeMap to use for emission. You can also set a Intensity. Intensity are multiplied over the Texture.");
            
            public static readonly GUIContent emissionCubeMapLod = new GUIContent("Emission CubeMap Lod",
                "Sets a Texture CubeMap to use for emission. You can also set a Lod.");
            //PicoVideo;LightMode;XiaoPengCheng;End

            //PicoVideo;LightMode;XiaoPengCheng;Begin
            public static readonly GUIContent adjustColorIntensity = new GUIContent("Global Adjust Color Intensity",
                "Sets Intensity Of Global Adjust Color.");
            //PicoVideo;LightMode;XiaoPengCheng;End

            //PicoVideo;LayerMaterials;XiaoPengCheng;Begin
            public static readonly GUIContent layerBlends = new GUIContent("Layer Blends",
                "Material Layer Blend Options");
        ...
        //PicoVideo;LightMode;XiaoPengCheng;Begin
        protected MaterialProperty emssionCubemapProp { get; set; }
        
        protected MaterialProperty emissionCubemapIntensityProp { get; set; }
        
        protected MaterialProperty emissionCubemapLodProp { get; set; }

        //PicoVideo;LightMode;XiaoPengCheng;End

        //PicoVideo;LightMode;XiaoPengCheng;Begin
        protected MaterialProperty adjustColorIntensityProp { get; set; }
        ...
        public virtual void FindProperties(MaterialProperty[] properties)
        {
            ...
            applyVertexColorProp = FindProperty("_ApplyVertexColor", properties, false);
            emissionMapProp = FindProperty("_EmissionMap", properties, false);
            emissionColorProp = FindProperty("_EmissionColor", properties, false);
            
            //PicoVideo;LightMode;XiaoPengCheng;Begin
            emssionCubemapProp = FindProperty("_EmssionCubemap", properties);
            emissionCubemapIntensityProp = FindProperty("_EmissionCubemapIntensity", properties);
            emissionCubemapLodProp = FindProperty("_EmissionCubemapLod", properties);
            //PicoVideo;LightMode;XiaoPengCheng;End

            //PicoVideo;LightMode;XiaoPengCheng;Begin
            adjustColorIntensityProp = FindProperty("_AdjustColorIntensity", properties);
            //PicoVideo;LightMode;XiaoPengCheng;End
        ...
        public virtual void DrawSurfaceOptions(Material material)
        {
            ...
            //PicoVideo;LightMode;XiaoPengCheng;Begin
            if (adjustColorIntensityProp != null)
            {
                materialEditor.ShaderProperty(adjustColorIntensityProp, Styles.adjustColorIntensity);
            }
            //PicoVideo;LightMode;XiaoPengCheng;End
        }
        ...
        //PicoVideo;LightMode;YangFan;Begin
        public void TexturePropertyWithHDRColor(
            MaterialEditor materialEditor,
            GUIContent colorLabel,
            GUIContent textureLabel,
            ...
            bool showAlpha)
        {
            if (baseMapProp != null && baseColorProp != null) // Draw the baseMap, most shader will have at least a baseMap
            {
                ...
                EditorGUILayout.LabelField(colorLabel.text);
                colorProperty.colorValue = EditorGUILayout.ColorField(GUIContent.none, colorProperty.colorValue, 
                    true , showAlpha,  
                    true,GUILayout.Width(EditorGUIUtility.singleLineHeight * 4));
                EditorGUILayout.EndHorizontal();
                TexturePropertyBody(materialEditor, textureProp, textureLabel.text);
            }
        }
        
        
        protected void DrawSLitInputEmissionProperties(Material material, bool keyword)
        {
            var emissive = true;
            ...
            if (!keyword)
            {
                TexturePropertyWithHDRColor(materialEditor, Styles.emissionColor, Styles.emissionMap, emissionMapProp, emissionColorProp, false);
                
                //PicoVideo;LightMode;XiaoPengCheng;Begin
                if (emssionCubemapProp != null && emissionCubemapIntensityProp != null && emissionCubemapLodProp != null)
                {
                    materialEditor.TexturePropertySingleLine(Styles.emissionCubeMap, emssionCubemapProp, emissionCubemapIntensityProp);
                    materialEditor.ShaderProperty(emissionCubemapLodProp, Styles.emissionCubeMapLod);
                }
                //PicoVideo;LightMode;XiaoPengCheng;End
            }
            else
        ...
        public static void DrawSLitInputNormalArea(MaterialEditor materialEditor, MaterialProperty bumpMap, MaterialProperty bumpMapBias, MaterialProperty bumpMapScale = null)
        {
            if (bumpMapScale != null)
            {
                //materialEditor.TextureProperty(bumpMap, "Normal(RG),Metallic(B),Smoothness(A)");
                TexturePropertyBody(materialEditor, bumpMap, "Normal(RG),Metallic(B),Smoothness(A)");
                
                if (bumpMap.textureValue != null)
                {
                    materialEditor.FloatProperty(bumpMapScale, "Normal Scale");
                    materialEditor.RangeProperty(bumpMapBias, "Normal Map Mipmap Bias");
                }
            }
            else
            {
        ...
        protected static Texture TexturePropertyBody(MaterialEditor materialEditor, MaterialProperty prop , string displayName, bool showTilingAndOffset = true , string helpText = "")
        {
            System.Type typeFromDimension = typeof(Texture);
            ...
            EditorGUILayout.BeginHorizontal(GUILayout.Height(EditorGUIUtility.singleLineHeight * 4));
            ...
            Texture texture = EditorGUILayout.ObjectField(new GUIContent(), 
                prop.textureValue, typeFromDimension , 
                false , 
                GUILayout.Width(EditorGUIUtility.singleLineHeight * 4) , 
                GUILayout.Height(EditorGUIUtility.singleLineHeight * 4)) as Texture;
            EditorGUILayout.EndHorizontal();
        ...
        public static void SetMaterialKeywords(Material material, Action<Material> shadingModelFunc = null, Action<Material> shaderFunc = null)
        {
            ...
            //PicoVideo;LightMode;XiaoPengCheng;Begin
            bool shouldCubeMapEmissionBeEnabled = false;
            if (shouldEmissionBeEnabled && material.HasProperty("_EmssionCubemap"))
            {
                shouldCubeMapEmissionBeEnabled = material.GetTexture("_EmssionCubemap") != null;
            }
            CoreUtils.SetKeyword(material, "_EMISSION_CUBEMAP", shouldCubeMapEmissionBeEnabled);
            //PicoVideo;LightMode;XiaoPengCheng;End
