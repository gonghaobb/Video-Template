...
namespace UnityEditor.Rendering.Universal.ShaderGUI
{
    [MovedFrom("UnityEditor.Rendering.LWRP.ShaderGUI")] public static class LitGUI
    {
        ...
        public struct LitProperties
        {
            ...
            public MaterialProperty lightmapSpecular;
            ...
            public LitProperties(MaterialProperty[] properties)
            {
                ...
                //PicoVideo;LightMode;Ernst;Begin
                lightmapSpecular = BaseShaderGUI.FindProperty("_LightmapSpecular", properties, false);
                //PicoVideo;LightMode;Ernst;End
                // Advanced Props
        ...
        public static void Inputs(LitProperties properties, MaterialEditor materialEditor, Material material)
        {
            ...
            //PicoVideo;LightMode;Ernst;Begin
            if (properties.lightmapSpecular != null)
            {
                var lightmapSpecularValue = EditorGUILayout.Slider(new GUIContent("LightmapSpecular", ""), properties.lightmapSpecular.floatValue, 0f, 1f);
                properties.lightmapSpecular.floatValue = lightmapSpecularValue;
            }
            //PicoVideo;LightMode;Ernst;End
        ...
        public static void SInputs(LitProperties properties, MaterialEditor materialEditor, Material material, MaterialProperty bumpMapBiasProp)
        {
            BaseShaderGUI.DrawSLitInputNormalArea(materialEditor, properties.bumpMapProp, bumpMapBiasProp, properties.bumpScaleProp);
            //PicoVideo;MipmapBias;ZhengLingFeng;End
            SDoMetallicSpecularArea(properties, materialEditor, material);
        ...
        //PicoVideo;LightMode;Ernst;Begin
        public static void SDoMetallicSpecularArea(LitProperties properties, MaterialEditor materialEditor, Material material)
        {
            string[] smoothnessChannelNames;
            bool hasGlossMap = false;
            // if (properties.workflowMode == null ||
            ...
            // {
                ...
                var metalValue = EditorGUILayout.Slider("Metallic Scale", properties.metallic.floatValue, 0f, 1f);
                if (EditorGUI.EndChangeCheck())
                    properties.metallic.floatValue = metalValue;
            ...
            // }
            //EditorGUI.indentLevel++;
            SDoSmoothness(properties, material, smoothnessChannelNames);
            
            var aoValue = EditorGUILayout.Slider(Styles.occlusionText, properties.occlusionStrength.floatValue, 0f, 1f);
            if (EditorGUI.EndChangeCheck())
                properties.occlusionStrength.floatValue = aoValue;
            
            var lightmapSpecularValue = EditorGUILayout.Slider(new GUIContent("LightmapSpecular",
                ""), properties.lightmapSpecular.floatValue, 0f, 1f);
            if (EditorGUI.EndChangeCheck())
                properties.lightmapSpecular.floatValue = lightmapSpecularValue;
            //EditorGUI.indentLevel--;
        }
        
        public static void SDoSmoothness(LitProperties properties, Material material, string[] smoothnessChannelNames)
        {
            ...
            var smoothness = EditorGUILayout.Slider("Smoothness Scale", properties.smoothness.floatValue, 0f, 1f);
            if (EditorGUI.EndChangeCheck())
