...
#region RenderStates
    static class CoreRenderStates
    {
        public static readonly RenderStateCollection Default = new RenderStateCollection
        {
            ...
            { RenderState.Blend(Blend.SrcAlpha, Blend.One, Blend.Zero, Blend.One), new FieldCondition(UniversalFields.BlendAdd, true) },//PicoVideo;OptimizedOverlayAlphaBlend;WuJunLin
