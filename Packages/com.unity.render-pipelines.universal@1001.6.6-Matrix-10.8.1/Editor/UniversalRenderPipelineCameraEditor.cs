...
namespace UnityEditor.Rendering.Universal
{
    ...
    class UniversalRenderPipelineCameraEditor : CameraEditor
    {
        ...
        static class Styles
        {
            ...
            public static GUIContent beforePostLayerMask = EditorGUIUtility.TrTextContent("Before Post Mask", "Draw objects before postprocess.");
            public static GUIContent overlayLayerMask = EditorGUIUtility.TrTextContent("Overlay Mask", "Draw objects after postprocess.");
            public static GUIContent extendRenderGroup = EditorGUIUtility.TrTextContent("Extend Render", "");
        ...
        SavedBool m_ExtendRenderFoldout;
        ...
        SerializedProperty m_BeforePostLayerMask;
        SerializedProperty m_BeforePostClearDepth; 
        SerializedProperty m_OverlayLayerMask; 
        
        //PicoVideo;DynamicResolution;Ernst;Begin
        SerializedProperty m_RTDynamicResolutionTypeProp;
        ...
        public new void OnEnable()
        {
            ...
            m_ExtendRenderFoldout = new SavedBool($"{target.GetType()}.ExtendRenderFoldout", false);
...
#endif
            m_BeforePostLayerMask = m_AdditionalCameraDataSO.FindProperty("m_BeforePostLayerMask");
            m_BeforePostClearDepth = m_AdditionalCameraDataSO.FindProperty("m_BeforePostClearDepth");
            m_OverlayLayerMask = m_AdditionalCameraDataSO.FindProperty("m_OverlayLayerMask");
            //PicoVideo;DynamicResolution;Ernst;Begin
            m_RTDynamicResolutionTypeProp = m_AdditionalCameraDataSO.FindProperty("m_RTDynamicResolutionType");
            //PicoVideo;DynamicResolution;Ernst;End
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            DrawDynamicResolutionSettings(camType);//PicoVideo;DynamicResolution;Ernst
        ...
        //PicoVideo;DynamicResolution;Ernst;Begin
        public static int[] dynamicResolutionTypeDataOptions = Enum.GetValues(typeof(RTDynamicResolutionType)).Cast<int>().ToArray();
        public static GUIContent[] dynamicResolutionTypeDataOptionsCentent =
        {
            new GUIContent("Use Dynamic Resolution"),
            new GUIContent("Keep Color Resolution Only"),
            new GUIContent("Keep Color And Depth Resoluton")
        };

        void DrawDynamicResolutionType()
        {
            m_AdditionalCameraDataSO.Update();

            Rect controlRectColor = EditorGUILayout.GetControlRect(true);
            EditorGUI.BeginProperty(controlRectColor, EditorGUIUtility.TrTextContent("Keep Resolution Size", ""), m_RTDynamicResolutionTypeProp);
            EditorGUI.BeginChangeCheck();

            EditorGUI.BeginProperty(controlRectColor, EditorGUIUtility.TrTextContent("Selection", ""), m_RTDynamicResolutionTypeProp);
            EditorGUI.BeginChangeCheck();
            int selectedValue = EditorGUI.IntPopup(controlRectColor, EditorGUIUtility.TrTextContent("Selection", ""), m_RTDynamicResolutionTypeProp.enumValueIndex, dynamicResolutionTypeDataOptionsCentent, dynamicResolutionTypeDataOptions);
            if (EditorGUI.EndChangeCheck())
            {
                m_RTDynamicResolutionTypeProp.enumValueIndex = selectedValue;
                m_AdditionalCameraDataSO.ApplyModifiedProperties();
            }
            EditorGUI.EndProperty();
        }

        void DrawDynamicResolutionSettings(CameraRenderType cameraType)
        {
            if (cameraType == CameraRenderType.Overlay)
            {
                m_RenderingSettingsFoldout.value = EditorGUILayout.BeginFoldoutHeaderGroup(m_RenderingSettingsFoldout.value,
                                   EditorGUIUtility.TrTextContent("Dynamic Resolution", ""));
                if (m_RenderingSettingsFoldout.value)
                {
                    DrawDynamicResolutionType();
        ...
        void DrawExtendRender()
        {
            m_ExtendRenderFoldout.value = EditorGUILayout.BeginFoldoutHeaderGroup(m_ExtendRenderFoldout.value, Styles.extendRenderGroup);
            if (m_ExtendRenderFoldout.value)
            {
                EditorGUILayout.PropertyField(m_BeforePostClearDepth, Styles.clearDepth);
                EditorGUILayout.PropertyField(m_BeforePostLayerMask, Styles.beforePostLayerMask);
                EditorGUILayout.PropertyField(m_OverlayLayerMask, Styles.overlayLayerMask);
            }
            EditorGUILayout.EndFoldoutHeaderGroup();
        }
