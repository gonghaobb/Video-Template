...
namespace UnityEngine.Rendering.Universal
{
    ...
    public class PostProcessData : ScriptableObject
    {
        ...
        public sealed class ShaderResources
        {
            ...
            [Reload("Runtime/Extend/FSR/PostProcessing/Shaders/ScalingSetup.shader")]
            public Shader scalingSetupPS;

            [Reload("Runtime/Extend/FSR/PostProcessing/Shaders/EdgeAdaptiveSpatialUpsampling.shader")]
            ...
            [Reload("Shaders/PostProcessing/DebugPost.shader")]
            public Shader debugPassPS;
