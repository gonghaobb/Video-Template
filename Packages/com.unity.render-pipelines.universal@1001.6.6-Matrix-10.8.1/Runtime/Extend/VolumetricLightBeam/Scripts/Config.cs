...
namespace VLB
{
    ...
    public class Config : ScriptableObject
    {
        ...
        private const string s_PackageRoot = "Packages/com.unity.render-pipelines.universal";
...
#pragma warning restore 0414
        ...
        [Reload("Runtime/Extend/VolumetricLightBeam/Resources/Shaders/VLBGeneratedShader.shader")]
...
#if UNITY_EDITOR
            ResourceReloader.TryReloadAllNullIn(obj, s_PackageRoot);
#endif
        }
