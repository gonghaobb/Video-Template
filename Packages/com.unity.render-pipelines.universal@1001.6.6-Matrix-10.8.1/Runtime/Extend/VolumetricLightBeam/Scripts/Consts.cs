...
namespace VLB
{
    public static class Consts
    {
        ...
        public static class Beam
        {
            ...
            public static readonly Gradient GradientColor = new Gradient();
            ...
            public static readonly VolumetricLightBeam.LODGeomSettings geomSettingsLOD0Default = new VolumetricLightBeam.LODGeomSettings() { geomSides = 24, geomSegments = 10 , screenRelativeTransitionHeight = 0.9f};
            public static readonly VolumetricLightBeam.LODGeomSettings geomSettingsLOD1Default = new VolumetricLightBeam.LODGeomSettings() { geomSides = 20, geomSegments = 8 , screenRelativeTransitionHeight = 0.7f};
            public static readonly VolumetricLightBeam.LODGeomSettings geomSettingsLOD2Default = new VolumetricLightBeam.LODGeomSettings() { geomSides = 18, geomSegments = 6 , screenRelativeTransitionHeight = 0.5f};
            public static readonly VolumetricLightBeam.LODGeomSettings geomSettingsLOD3Default = new VolumetricLightBeam.LODGeomSettings() { geomSides = 15, geomSegments = 5 , screenRelativeTransitionHeight = 0.25f};
            public static readonly VolumetricLightBeam.LODGeomSettings geomSettingsLOD4Default = new VolumetricLightBeam.LODGeomSettings() { geomSides = 12, geomSegments = 4 , screenRelativeTransitionHeight = 0.03f};
        }
        ...
        public static class Config
        {
            ...
            public const RenderPipeline GeometryRenderPipelineDefault = RenderPipeline.URP;
            public const RenderingMode GeometryRenderingModeDefault = RenderingMode.SRPBatcher;
