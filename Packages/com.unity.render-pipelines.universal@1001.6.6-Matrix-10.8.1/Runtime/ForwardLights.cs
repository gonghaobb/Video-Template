...
namespace UnityEngine.Rendering.Universal.Internal
{
    ...
    public class ForwardLights
    {
        static class LightConstantBuffer
        {
            ...
            public static int _BakeGIIntensityMultiplier;   // 控制烘焙GI强度
        ...
        public ForwardLights()
        {
            ...
            //PicoVideo;LightMode;YangFan;Begin
            LightConstantBuffer._BakeGIIntensityMultiplier = Shader.PropertyToID("_BakeGIIntensityMultiplier");
            //PicoVideo;LightMode;YangFan;End
        }
        ...
        void SetupShaderLightConstants(CommandBuffer cmd, ref RenderingData renderingData)
        {
            ...
            //PicoVideo;LightMode;YangFan;Begin
            cmd.SetGlobalFloat(LightConstantBuffer._BakeGIIntensityMultiplier, UniversalRenderPipeline.asset.bakeGIIntensityMultiplier);
            if (UniversalRenderPipeline.asset.dirSpecularLightingmapEnable)
            {
                cmd.EnableShaderKeyword("_MATRIX_SPC_LIGHTINGMAP");
                cmd.SetGlobalFloat("_GlobalLightmapSpecular", UniversalRenderPipeline.asset.dirSpecularLightingingmapMultiplier);
            }
            else
            {
                cmd.DisableShaderKeyword("_MATRIX_SPC_LIGHTINGMAP");
            }
            //PicoVideo;LightMode;YangFan;End
        }
