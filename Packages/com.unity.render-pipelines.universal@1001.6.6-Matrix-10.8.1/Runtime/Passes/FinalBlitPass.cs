    ...
    public class FinalBlitPass : ScriptableRenderPass
    {
        ...
        public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            using (new ProfilingScope(cmd, ProfilingSampler.Get(URPProfileId.FinalBlit)))
            {
                ...
                bool isSubsampledLayout = UniversalRenderPipeline.IsEnableFoveatedRenderingAndSubsampledLayout(m_Source.id);
                CoreUtils.SetKeyword(m_BlitMaterial, ShaderKeywordStrings.UseFoveatedSubsampledLayout, isSubsampledLayout);
                cmd.SetGlobalTexture(isSubsampledLayout ? ShaderPropertyId.subsampledLayoutSourceTex : ShaderPropertyId.sourceTex, m_Source.Identifier());
                //PicoVideo;FoveatedFeature;YangFan;Begin
