...
namespace UnityEngine.Rendering.Universal
{
    ...
    public enum ScriptableRenderPassInput
    {
        ...
        CreateColorTexture = 1 << 3,
        UseStencilBuffer = 1 << 4,
        UseStencilInPost = 1 << 5,
        SupportSubPass = 1 << 6
    ...
    [MovedFrom("UnityEngine.Rendering.LWRP")] public abstract partial class ScriptableRenderPass
    {
        ...
        public virtual void EarlyConfigure(ScriptableRenderContext context, ref RenderingData renderingData) {}
