...
namespace UnityEngine.Rendering.Universal
{
    ...
    [MovedFrom("UnityEngine.Rendering.LWRP")] public static class RenderingUtils
    {
        ...
        //PicoVideo;AppSW;Ernst;Begin
        internal static void SetStereoViewAndProjectionMatrices(CommandBuffer cmd, Matrix4x4[] viewMatrix, Matrix4x4[] projMatrix, Matrix4x4[] cameraProjMatrix, bool setInverseMatrices, bool prevViewValid, Matrix4x4[] prevViewMatrix, bool useMotionVector)
        //PicoVideo;AppSW;Ernst;End
        {
            //PicoVideo;AppSW;Ernst;Begin
            if (useMotionVector)
