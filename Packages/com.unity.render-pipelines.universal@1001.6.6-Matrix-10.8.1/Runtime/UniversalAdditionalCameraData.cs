...
namespace UnityEngine.Rendering.Universal
{
    ...
    [MovedFrom("UnityEngine.Rendering.LWRP")] public class UniversalAdditionalCameraData : MonoBehaviour, ISerializationCallbackReceiver
    {
        ...
        [SerializeField]
        public RTDynamicResolutionType m_RTDynamicResolutionType = RTDynamicResolutionType.UseDynamicResolution;
        ...
        [SerializeField] LayerMask m_BeforePostLayerMask = 0;
        [SerializeField] bool m_BeforePostClearDepth = false;
        [SerializeField] LayerMask m_OverlayLayerMask = 0;
        ...
        public LayerMask beforePostLayerMask
        {
            set => m_BeforePostLayerMask = value;
            get => m_BeforePostLayerMask;
        }
        
        public bool beforePostClearDepth
        {
            set => m_BeforePostClearDepth = value;
            get => m_BeforePostClearDepth;
        }
        
        public LayerMask overlayLayerMask
        {
            set => m_OverlayLayerMask = value;
            get => m_OverlayLayerMask;
        }
