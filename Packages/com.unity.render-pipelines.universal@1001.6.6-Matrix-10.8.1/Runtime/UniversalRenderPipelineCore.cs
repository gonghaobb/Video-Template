...
namespace UnityEngine.Rendering.Universal
{
    ...
    [MovedFrom("UnityEngine.Rendering.LWRP")] public struct RenderingData
    {
        ...
        public bool maximumEyeBufferRenderingEnabled;
    ...
    public enum RTDynamicResolutionType
    {
        UseDynamicResolution,
        KeepColorResolutionOnly,
        KeepColorAndDepthResoluton,
    }
    ...
    [MovedFrom("UnityEngine.Rendering.LWRP")] public struct CameraData
    {
        ...
        internal FSRUtils.ImageScalingMode imageScalingMode;
        internal FSRUtils.ImageUpscalingFilter upscalingFilter;
        ...
        //PicoVideo;OptimizedRenderPipeline;BaoQinShun;Begin
        public int cameraIndexInStack;
        public int lastCameraIndexWhoNeedOffScreen;
        public bool includeOverlay;
        //PicoVideo;OptimizedRenderPipeline;BaoQinShun;End
        
        //PicoVideo;DynamicResolution;Ernst;Begin
        public RTDynamicResolutionType rtDynamicResolutionType;
        //PicoVideo;DynamicResolution;Ernst;End
        ...
        internal bool requireSrgbConversion
        {
            get
            {
                //PicoVideo;FinalBlitSRGBConversion;ZhengLingFeng;Begin
#if UNITY_EDITOR
    #if ENABLE_VR && ENABLE_XR_MODULE
                if (xr.enabled)
                ...
                {
                    return (!targetTexture.sRGB) && (QualitySettings.activeColorSpace == ColorSpace.Linear);
                }
                else
                {
                    if (xr.enabled)
    ...
    #endif
#endif
                //PicoVideo;FinalBlitSRGBConversion;ZhengLingFeng;End
    ...
    internal static class ShaderPropertyId
    {
        ...
        public static readonly int prevViewAndProjectionMatrix = Shader.PropertyToID("unity_MatrixPrevVP");
        ...
        public static readonly int subsampledLayoutSourceTex = Shader.PropertyToID("_SubsampledLayoutSourceTex");
        ...
        public static readonly int globalAdjustColor = Shader.PropertyToID("_GlobalAdjustColor");
        //PicoVideo;LightMode;XiaoPengCheng;End
        
        //PicoVideo;UIDarkenMode;ZhouShaoyang;Begin
        public static readonly int globalDarkenColor = Shader.PropertyToID("_GlobalUIDarkenColor");
    ...
    public static class ShaderKeywordStrings
    {
        ...
        //PicoVideo;FoveatedFeature;YangFan;Begin        
        public static readonly string UseFoveatedSubsampledLayout = "USE_FOVEATED_SUBSAMPLED_LAYOUT";
        //PicoVideo;FoveatedFeature;YangFan;End
    ...
    public sealed partial class UniversalRenderPipeline
    {
            ...
            bool isHdrEnabled, int msaaSamples, bool needsAlpha, bool requiresOpaqueTexture)
        {
            ...
            desc.useDynamicScale = camera.targetTexture == null && DynamicResolutionController.excutedType == DynamicResolutionController.DynamicResolutionType.Hardware;
            //PicoVideo;DynamicResolution;Ernst;End
        ...
        //PicoVideo;FoveatedFeature;YangFan;Begin
        private static List<uint> s_ShadingRateLevelList = new List<uint>()
        {
            0x96A6,
            0x96A7,
            0x96A8,
        ...
        public static void SetShadingRate(CommandBuffer cmd, URPShadingRateLevel level)
        {
#if !UNITY_EDITOR && UNITY_ANDROID && PICO_VIDEO_VRS_EXTEND1_SUPPORTED
    #if PICO_VIDEO_VRS_EXTEND2_SUPPORTED
        cmd.SetShadingRate((CommandBuffer.ShadingRateLevel) level);
    #else
        cmd.SetShadingRate((CommandBuffer.ShadingRateLevel) s_ShadingRateLevelList[(int) level]);
    #endif
#endif
        }
        //PicoVideo;FoveatedFeature;YangFan;End
    ...
    //PicoVideo;FoveatedFeature;YangFan;Begin
    public enum URPShadingRateLevel
    {
        ShadingRate1x1 = 0, //0x96A6
        ShadingRate1x2 = 1, //0x96A7
        ShadingRate2x1 = 2, //0x96A8
        ShadingRate2x2 = 3, //0x96A9
        ShadingRate4x2 = 4, //0x96AC
        ShadingRate4x4 = 5, //0x96AE
    };
    //PicoVideo;FoveatedFeature;YangFan;End
    ...
    internal enum URPProfileId
    {
        ...
        DrawBeforePostOpaqueObjects,
        DrawBeforePostTransparentObjects,
        //PicoVideo;AppSW;Ernst;Begin
        DrawMVOpaqueObjects,
        //PicoVideo;AppSW;Ernst;End
        ...
        DrawOverlayOpaqueObjects,
        DrawOverlayTransparentObjects,
