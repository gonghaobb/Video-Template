Shader "Hidden/Universal Render Pipeline/UberPost"
{
    HLSLINCLUDE
        ...
        #pragma multi_compile_local_fragment _ _TONEMAP_ACES //_HDR_GRADING _TONEMAP_NEUTRAL
        ...
        half4 Frag(Varyings input) : SV_Target
        {
            ...
            #if _CHROMATIC_ABERRATION
            {
                ...
                float2 uvOffset = float2(_Chroma_Params.y, _Chroma_Params.z);
                float2 end = uv - coords * dot(coords, coords) * ChromaAmount - uvOffset;
            ...
            {
                //PicoVideo;CompositorLayers;Ernst;Begin
                half4 col = SAMPLE_TEXTURE2D_X(_SourceTex, sampler_LinearClamp, uvDistorted); 
                color = col.xyz;
                alpha = col.w;
                //PicoVideo;CompositorLayers;Ernst;End
            }
            ...
            {
                //PicoVideo;CompositorLayers;Ernst;Begin
                color = ApplyVignette(float4(color, alpha), uvDistorted, VignetteCenter, VignetteIntensity, VignetteRoundness, VignetteSmoothness, VignetteColor);
                //PicoVideo;CompositorLayers;Ernst;Begin
            }
