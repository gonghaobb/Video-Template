# Changelog for pico customized version
## [3.0.7-Matrix-1] - 2021-04-25
### Changes
- Modify from LoveEngine TextMeshPro V2 Extend http://gitea.c4games.com:5000/-/web/detail/com.unity.textmeshpro/v/403.0.294
- Add support for fallback os fonts 
