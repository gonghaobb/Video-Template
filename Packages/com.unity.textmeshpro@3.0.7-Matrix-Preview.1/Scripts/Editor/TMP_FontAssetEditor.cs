    ...
    public class TMP_FontAssetEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (UI_PanelState.generationSettingsPanel)
            {
                ...
                {
                    m_AtlasSettings.sourceFont = m_fontAsset.SourceFont_EditorRef;
                ...
                EditorGUI.BeginDisabledGroup(sourceFont == null);
                {
                    ...
                    if (EditorGUI.EndChangeCheck())
                    {
                        ...
                        else // Dynamic font asset
                        {
                            ...
                            if (m_AtlasPopulationMode_prop.intValue == 1)
                            {
                            ...
                            {
                                m_fontAsset.sourceFontFile = null;
                                Debug.Log("Atlas Population mode set to [DynamicOS].");
                            }
                        }
        ...
        {
            m_fontAsset.SourceFont_EditorRef = m_AtlasSettings.sourceFont;
            m_FontFaceIndex_prop.intValue = m_AtlasSettings.faceIndex;
