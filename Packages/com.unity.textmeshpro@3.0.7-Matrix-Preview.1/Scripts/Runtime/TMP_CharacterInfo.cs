...
namespace TMPro
{
    ...
    {
	    // deal.g: change from char to uint, for quad char code support
        public uint character; // Should be changed to an int to handle UTF 32
        /// <summary>
        ...
        public float adjustedHorizontalAdvance; // since 3.2
