...
namespace TMPro
{
    ...
    public struct FontAssetCreationSettings
    {
        ...
        public string[] fallBackFontList;

        internal FontAssetCreationSettings(string sourceFontFileGUID, int pointSize, int pointSizeSamplingMode, int padding, int packingMode, int atlasWidth, int atlasHeight, int characterSelectionMode, string characterSet, int renderMode, int fallBackCount = 0, string[] fallBackList = null)
        {
            ...
            this.fallBackFontList = fallBackList;
        }
    }
