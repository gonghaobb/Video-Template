...
namespace TMPro
{
    public class TMP_TextParsingUtilities
    {
        ...
        /// <summary> Time33 Hash algorithm one
        /// Function UpdateHashCode value of a given character.
        /// </summary>
        /// <param name="prevHashCode"></param>
        /// <param name="c">The new character</param>
        /// <returns></returns>
        public static int UpdateHashCode(int prevHashCode, char c)
        {
            return ((prevHashCode << 5) + prevHashCode) ^ ToUpperASCIIFast(c);
        }
        
        //PicoVideo;TextMeshProExtension;WuJunLin;Start
        /// <summary>
        /// Function UpdateHashCode value of a given character with case sensitive.
        /// </summary>
        public static int UpdateHashCodeSensitive(int prevHashCode, char c)
        {
            return ((prevHashCode << 5) + prevHashCode) ^ c;
        }
        ...
        {
            // modified by LoveEngine
            // http://www.hipenpal.com/tool/characters_to_unicode_charts_in_simplified_chinese.php?unicode=114
            
            //PicoVideo;TextMeshProExtension;WuJunLin;Start
            //先去掉这项以缩小修改影响范围，待后续有需要时再考虑启用
            // return c >= 0x3000  && c <= 0x303F  || /* CJK Punctuation LoveEngine Modified*/
