        ...
        public static int FindIntersectingLink(TMP_Text text, Vector3 position, Camera camera)
        {
            ...
            for (int i = 0; i < text.textInfo.linkCount; i++)
            {
                ...
                for (int j = 0; j < linkInfo.linkTextLength; j++)
                {
					...
					// deal.g: link click area spread support
                    float spreadAscender = TMP_Settings.linkClickAreaSpread.x / currentCharInfo.scale;
                    float spreadDescender = TMP_Settings.linkClickAreaSpread.y / currentCharInfo.scale;
                    ...
                    if (isBeginRegion == false)
                    {
                        ...
                        bl = rectTransform.TransformPoint(new Vector3(currentCharInfo.bottomLeft.x, currentCharInfo.descender - spreadDescender, 0));
                        tl = rectTransform.TransformPoint(new Vector3(currentCharInfo.bottomLeft.x, currentCharInfo.ascender + spreadAscender, 0));
                        ...
                        if (linkInfo.linkTextLength == 1)
                        {
                            ...
                            br = rectTransform.TransformPoint(new Vector3(currentCharInfo.topRight.x, currentCharInfo.descender - spreadDescender, 0));
                            tr = rectTransform.TransformPoint(new Vector3(currentCharInfo.topRight.x, currentCharInfo.ascender + spreadAscender, 0));
