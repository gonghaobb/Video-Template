...
namespace TMPro
{
    ...
    public struct WordWrapState
    {
        ...
        public int visibleSpaceCount; // new
        ...
        public float renderedWidth; // new
        public float renderedHeight; // new
        ...
        public float lineOffset;
        public bool isDrivenLineSpacing;
        public int lastBaseGlyphIndex; // change public float glyphHorizontalAdvanceAdjustment;
        ...
        public Color32 strikethroughColor;
        // public Color32 highlightColor;
		public HighlightState highlightState; // change
        public TMP_FontStyleStack basicStyleStack;
        ...
        public Quaternion fxRotation; // new
        public Vector3 fxScale; // new
    }
