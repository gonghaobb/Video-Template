...
namespace UnityEditor.UI
{
    ...
    public class GraphicEditor : Editor
    {
        ...
        SerializedProperty m_EnableAlphaMask;
        SerializedProperty m_AlphaMaskTexture;
        ...
        protected virtual void OnEnable()
        {
            ...
            //PicoVideo;SoftMask;XiaoPengCheng;Begin
            m_EnableAlphaMask = serializedObject.FindProperty("m_EnableAlphaMask");
            m_AlphaMaskTexture = serializedObject.FindProperty("m_AlphaMaskTexture");
            //PicoVideo;SoftMask;XiaoPengCheng;End
        ...
        protected void MaskableControlsGUI()
        {
            ...
            //PicoVideo;SoftMask;XiaoPengCheng;Begin
            if (serializedObject.targetObject is Image || serializedObject.targetObject is RawImage)
            {
                EditorGUILayout.PropertyField(m_EnableAlphaMask);
                if (m_EnableAlphaMask.boolValue)
                {
                    EditorGUI.indentLevel++;
                    EditorGUILayout.PropertyField(m_AlphaMaskTexture);
                    EditorGUI.indentLevel--;
                }
            }
            //PicoVideo;SoftMask;XiaoPengCheng;End
