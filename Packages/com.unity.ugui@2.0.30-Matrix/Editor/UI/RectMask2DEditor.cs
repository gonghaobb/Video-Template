...
namespace UnityEditor.UI
{
    ...
    public class RectMask2DEditor : Editor
    {
        ...
        SerializedProperty m_AllowInverse; //PicoVideo;RectMask2DAllowInverse;WuJunLin
        ...
        protected virtual void OnEnable()
        {
            ...
            m_AllowInverse = serializedObject.FindProperty("m_AllowInverse");//PicoVideo;RectMask2DAllowInverse;WuJunLin
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(m_AllowInverse); //PicoVideo;RectMask2DAllowInverse;WuJunLin
