namespace UnityEngine.EventSystems
{
    ...
    public abstract class UIBehaviour : MonoBehaviour
    {
        ...
        protected virtual void OnCanvasGroupChanged()
        {
            ...
            if (this is UnityEngine.UI.Graphic)
            {
                (this as UnityEngine.UI.Graphic).SetVerticesDirty();
            }
            else if (this is UnityEngine.UI.InputField)
            {
                (this as UnityEngine.UI.InputField).Rebuild(UnityEngine.UI.CanvasUpdate.LatePreRender);
            }
