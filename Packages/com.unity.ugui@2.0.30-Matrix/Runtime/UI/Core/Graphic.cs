...
namespace UnityEngine.UI
{
          ...
          ICanvasElement
    {
        ...
        protected Material m_CacheRenderMaterial = null; //PicoVideo;UIShineEffect;WuJunLin;
        ...
        [NonSerialized] protected UnityAction m_OnUpdateCompleteCallback;//PicoVideo;UIUpdateComplete;WuJunLin
        ...
        public virtual Material material
        {
            ...
            set
            {
                ...
                UIMaterials.RemoveModifyMaterial(m_Material);
                m_Material = value;
                SetMaterialDirty();
            }
        }
        
        //PicoVideo;UIShineEffect;WuJunLin;Begin
        /// <summary>
        /// The Cache Render Material
        /// </summary>
        public virtual Material cacheRendererMaterial
        {
            get { return m_CacheRenderMaterial; }
        }
        //PicoVideo;UIShineEffect;WuJunLin;End
        ...
        public virtual Material materialForRendering
        {
            get
            {
                ...
                if (this is IMaterialModifier modifier)
                {
                    //先换成定制UI材质
                    currentMat = modifier.GetModifiedMaterial(currentMat);
                }
                ...
                m_CacheRenderMaterial = currentMat;
        ...
        {
            //PicoVideo;UIUpdateComplete;WuJunLin;Start
            if (m_OnUpdateCompleteCallback != null)
                m_OnUpdateCompleteCallback();
            //PicoVideo;UIUpdateComplete;WuJunLin;End
        }
        ...
        private void DoMeshGeneration()
        {
            ...
            //PicoVideo;Linear;WuJunLin;Begin
            if (TryGetComponent(out Selectable button) && button.isActiveAndEnabled && button.transition == Selectable.Transition.ColorTint)
            {
                s_VertexHelper.FillMeshWithSpecifiedColor(workerMesh, (Color32)(m_Color * canvasRenderer.GetColor()), GetCanvasGroupAlpha());
            }
            else
            {
                s_VertexHelper.FillMesh(workerMesh, GetCanvasGroupAlpha()); //PicoVideo;Linear;xiaopengcheng
            }
            //PicoVideo;Linear;WuJunLin;End
...
#pragma warning restore 618
        ...
        {
            OnPopulateMesh(s_VertexHelper);
            s_VertexHelper.FillMesh(m, GetCanvasGroupAlpha());//PicoVideo;Linear;xiaopengcheng
        }
        ...
        //PicoVideo;Linear;xiaopengcheng;Begin
        public void SetCanvasRendererColor(Color targetColor)
        {
            if (canvasRenderer == null)
            {
                return;
            ...
            ListPool<Component>.Release(components);
            s_VertexHelper.FillMeshWithSpecifiedColor(workerMesh,newColor);
            //PicoVideo;Linear;WuJunLin;End

            if (workerMesh != null && workerMesh.colors.Length > 0)
            {
                canvasRenderer.SetMesh(workerMesh);
            }
        }
        //PicoVideo;Linear;xiaopengcheng;End
        ...
        public virtual void CrossFadeColor(Color targetColor, float duration, bool ignoreTimeScale, bool useAlpha, bool useRGB)
        {
            ...
            colorTween.AddOnChangedCallback(SetCanvasRendererColor);//PicoVideo;Linear;xiaopengcheng.hank;
        ...
        //PicoVideo;UIUpdateComplete;WuJunLin;Start
        /// <summary>
        /// Add a listener to receive notification when the graphics is Update Completed.
        /// </summary>
        /// <param name="action">The method to call when invoked.</param>
        public void RegisterUpdateCompleteCallback(UnityAction action)
        {
            m_OnUpdateCompleteCallback += action;
        }

        /// <summary>
        /// Remove a listener from receiving notifications when the graphics is Update Completed
        /// </summary>
        /// <param name="action">The method to call when invoked.</param>
        public void UnregisterUpdateCompleteCallback(UnityAction action)
        {
            m_OnUpdateCompleteCallback -= action;
        }
        //PicoVideo;UIUpdateComplete;WuJunLin;End
