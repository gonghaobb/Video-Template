...
namespace UnityEngine.UI
{
    ...
    public class RectMask2D : UIBehaviour, IClipper, ICanvasRaycastFilter
    {
        ...
        [SerializeField]
        private bool m_AllowInverse = false;
        
        public bool allowInverse
        {
            get { return m_AllowInverse; }
            set { m_AllowInverse = value; }
        }
        ...
        public Rect canvasRect
        {
            get
            {
                return m_VertexClipper.GetCanvasRect(rectTransform, Canvas, allowInverse);//PicoVideo;RectMask2DAllowInverse;WuJunLin
            }
        }
