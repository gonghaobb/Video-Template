...
namespace UnityEngine.UI
{
    ...
    public class VertexHelper : IDisposable
    {
        ...
        /// </summary>
        public void FillMesh(Mesh mesh, float alpha = 1.0f)
        {
            InitializeListIfRequired();
            ...
            {
                m_Uv1S[i] = new Vector4(m_Colors[i].r / 255f, m_Colors[i].g / 255f, m_Colors[i].b / 255f, alpha * m_Colors[i].a / 255f);
            }
        ...
        /// <summary>
        /// Fill the given mesh with the stream data with Specified Color.
        /// </summary>
        public void FillMeshWithSpecifiedColor(Mesh mesh, Color32 color, float alpha = 1.0f)
        {
            InitializeListIfRequired();
            ...
            mesh.SetColors(m_Colors);
            mesh.SetUVs(0, m_Uv0S);
            Vector4 uv1 = new Vector4(color.r / 255f, color.g / 255f, color.b / 255f, alpha * color.a / 255f);
            for (int i = 0; i < m_Colors.Count; ++i)
            {
                m_Uv1S[i] = uv1;
            }
