        ...
        public virtual string GetBlendModeStr()
        {
            switch (owner.blendMode)
            {
                case BlendMode.Additive:
                    return "Blend SrcAlpha One, Zero One";//PicoVideo;OptimizedOverlayAlphaBlend;WuJunLin
                case BlendMode.Alpha:
                    return "Blend SrcAlpha OneMinusSrcAlpha, One OneMinusSrcAlpha";//PicoVideo;OptimizedOverlayAlphaBlend;WuJunLin
