...
namespace LWGUI
{
	...
	internal class KWEnumDrawer : SubDrawer
	{
        ...
        public KWEnumDrawer(string group, string n1, string k1, string n2, string k2, string n3, string k3, string n4, string k4, string n5, string k5,
	        string n6, string k6, string n7, string k7)
	        : this(group, new string[7] { n1, n2, n3, n4, n5, n6, n7 }, new string[7] { k1, k2, k3, k4, k5, k6, k7 }) { }
        
        public KWEnumDrawer(string group, string n1, string k1, string n2, string k2, string n3, string k3, string n4, string k4, string n5, string k5,
	        string n6, string k6, string n7, string k7, string n8, string k8)
	        : this(group, new string[8] { n1, n2, n3, n4, n5, n6, n7, n8 }, new string[8] { k1, k2, k3, k4, k5, k6, k7, k8 }) { }
        
        public KWEnumDrawer(string group, string n1, string k1, string n2, string k2, string n3, string k3, string n4, string k4, string n5, string k5,
	        string n6, string k6, string n7, string k7, string n8, string k8, string n9, string k9)
	        : this(group, new string[9] { n1, n2, n3, n4, n5, n6, n7, n8, n9 }, new string[9] { k1, k2, k3, k4, k5, k6, k7, k8, k9 }) { }
		#endregion
