...
Shader "PicoVideo/Scene/Grass(Weather)"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        UsePass "PicoVideo/Scene/Grass/DepthOnly"
        UsePass "PicoVideo/Scene/Grass/MotionVectors"
        UsePass "PicoVideo/Scene/Grass/Meta"
