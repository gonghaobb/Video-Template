...
Shader "PicoURP_PBR"
{
    Properties
    {
	    ...
	    [Sub(_SurfaceOptionsUSE_BLINN_PHONG)][HDR]_BlingPhongSpecColor("SpecColor", Color) = (0,0,0,1)
    	...
    	[SubToggle(_Emission)] _ApplyEmissionVertexColor("Apply Emission VertexColor", float) = 0
